...
public class ArcProgressStackView extends View {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        for (int i = 0; i < mModels.size(); i++) {
            ...
            mTextPaint.setTextSize(mProgressModelSize * 0.6F);
            ...
            mTextPaint.getTextBounds(
                    model.getProgressTitle(), 0, model.getProgressTitle().length(), model.mTextBounds
            );
    ...
    public static class Model {
        ...
        public Model(final String title, final float progress, final int bgColor, final int color, final String progressTile) {
            setTitle(title);
            setProgress(progress);
            setColor(color);
            setBgColor(bgColor);
