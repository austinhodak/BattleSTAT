...
import com.brokenstrawapps.battlebuddy.models.MatchParticipant
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.mMatchData.observe(this, Observer { match ->
            ...
            for (kill in killList) {
                if (kill.killer?.name?.isEmpty() == true) {
            ...
            for (kill in killList) {
                if (kill.killer?.name?.isNotEmpty() == true && kill.victim.name.isNotEmpty()) {
