...
import com.ahcjapps.battlebuddy.info.TimerFragment
import com.ahcjapps.battlebuddy.map.MapDropRouletteActivity
...
import com.ahcjapps.battlebuddy.profile.ProfileMain
import com.ahcjapps.battlebuddy.rss.HomeUpdatesFragment
...
import com.ahcjapps.battlebuddy.weapons.HomeWeaponsFragment
    ...
    private fun setupRightDrawer() {
        ...
        mTopPlayersAdapater = SlimAdapter.create().attachTo(homePlayersRV).updateData(players).register<PlayerListModel>(R.layout.top_players_chip) { player, injector ->
            ...
            if (mSharedPreferences?.contains("playerRankTitle-${player.playerID}") == true) {
                ...
                cardView.backgroundTintList = ColorStateList.valueOf(resources.getColor(Ranks.getRankColor(0.0)))
            }
